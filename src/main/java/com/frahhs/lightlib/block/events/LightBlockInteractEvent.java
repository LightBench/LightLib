...
/**
 * Represents an event that is called when a player interacts with a Light block for each hand. The hand can be determined using getHand().
 */
public class LightBlockInteractEvent extends LightBlockEvent implements Cancellable {
    ...
    public LightBlockInteractEvent(@NotNull final LightBlock clickedBlock, @NotNull final PlayerInteractEvent playerInteractEvent) {
        super(clickedBlock);
