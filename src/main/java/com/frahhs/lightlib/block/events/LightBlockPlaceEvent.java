...
public class LightBlockPlaceEvent extends LightBlockEvent implements Cancellable {
    ...
    public LightBlockPlaceEvent(@NotNull final LightBlock placedBlock, @NotNull final BlockPlaceEvent blockPlaceEvent) {
        super(placedBlock);
    ...
    /**
     * Clarity method for getting the Light placed block. Not really needed except
     * for reasons of clarity.
     *
     * @return The LightBlock that was placed
     */
    @NotNull
    public LightBlock getBlockPlaced() {
        return getBlock();
    }
