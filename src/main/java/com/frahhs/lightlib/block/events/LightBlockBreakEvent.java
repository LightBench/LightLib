...
public class LightBlockBreakEvent extends LightBlockEvent implements Cancellable {
    ...
    public LightBlockBreakEvent(@NotNull final LightBlock placedBlock, @NotNull final BlockBreakEvent blockBreakEvent) {
        super(placedBlock);
